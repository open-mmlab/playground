...
def collect_hiertext_info(root_path, level, split, print_every=1000):
    ...
    annotation_path = osp.join(root_path + '/' + split + '.jsonl')
...
def parse_args():
    ...
    parser.add_argument(
        '--root_path',
        default='/media/jiangqing/jqssd/ICDAR-2023/gt/annotations',
        help='Root dir path of HierText')
    parser.add_argument(
        '--level',
        default='paragraph',
...
def main():
    ...
    val_infos = collect_hiertext_info(root_path, args.level, 'validation')
