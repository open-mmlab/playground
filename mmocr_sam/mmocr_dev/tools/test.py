...
def parse_args():
    ...
    parser.add_argument('config', default='configs/textdet/dbnetpp/dbnetpp_swinv2_base_w16_in21k_LAION400M.py', help='Test config file path')
    parser.add_argument('checkpoint',default='checkpoints/db_swin_mix_pretrain.pth', help='Checkpoint file')
    parser.add_argument(
        '--work-dir',
